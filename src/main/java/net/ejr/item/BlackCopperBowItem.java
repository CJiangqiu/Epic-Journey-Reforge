...
import net.ejr.procedures.BowUseEndProcedure;
import net.ejr.procedures.BlackCopperBowUseProcedure;

public class BlackCopperBowItem extends Item {
	public BlackCopperBowItem() {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			BlackCopperBowUseProcedure.execute(entity);
	}

	@Override
	public boolean onDroppedByPlayer(ItemStack itemstack, Player entity) {
		BowUseEndProcedure.execute(itemstack);
		return true;
	}
